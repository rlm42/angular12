...
namespace WebAPI.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        [HttpPost]
        public JsonResult Post(Employee emp) // Post Method to insert data
        {
            string query = @" 
        ...
        [HttpPut]
        public JsonResult Put(Employee emp) // Put method to update data
        {
            string query = @" 
        ...
        [Route("SaveFile")] // Our API method for our photos
        [HttpPost]
